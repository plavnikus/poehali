...
function qbadges(p){
 ...
 a.push(m.fit==='ok'?'<span class="qtag qok">✅ Подходит нам</span>':m.fit==='bad'?'<span class="qtag qbad">❌ Не наш формат</span>':'<span class="qtag qcaution">🟡 С оговорками</span>');
...
if(!document.getElementById('details-data')){const d=document.createElement('script');d.id='details-data';d.src='details.js?v=3';d.onload=()=>{const c=document.createElement('link');c.rel='stylesheet';c.href='details-style.css?v=1';document.head.appendChild(c);const r=document.createElement('script');r.src='details-render.js?v=2';document.body.appendChild(r)};document.body.appendChild(d)}
})();
